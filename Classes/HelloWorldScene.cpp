...
bool HelloWorld::init()
{
    ...
    pStartItem->setPosition(ccp(100,100));
    ...
    CCMenu* pMenuStart = CCMenu::create(pStartItem, NULL);
    pMenuStart->setPosition(CCPointZero);
    this->addChild(pMenuStart, 1);
    ...
    CCLabelTTF* pLabel = CCLabelTTF::create("hoasfffffeasddt", "Arial", 24);
